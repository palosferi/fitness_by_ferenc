...
def generate_day(day=None):
    ...
    return {
        ...
        "stress_latest": rng.randint(12, 70),
        "stress_latest_at": day.astimezone().isoformat(),
        "stress_max": rng.randint(70, 95),
        "respiration_avg": round(rng.uniform(12.5, 16.5), 1),
        "respiration_baseline": 14.2,
        "resting_hr_baseline": DEMO_RESTING_HR_BASELINE,
        "hrv_balanced_low": 42,
        "hrv_balanced_high": 68,
        "sleep_need_minutes": sleep_hours_rec * 60,
        "watch_synced_at": day.isoformat(timespec="seconds"),
        "spo2_avg": rng.randint(93, 98),
        "spo2_baseline": 95,
